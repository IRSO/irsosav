...
class Input {
    ...
    public function post($index = null){
        ...
        return trim($this->post);
    }
	
	/**
     * Get data from PUT method
     * @param string $index
     * @return mixed
     */
    public function put($index = null){
		parse_str(file_get_contents("php://input"),$elemento);
        if($index){
            return $elemento[$index];
        }
        return trim($elemento[$index]);
    }
	
	/**
     * Get data from DELETE method
     * @param string $index
     * @return mixed
     */
    public function del($index = null){
		parse_str(file_get_contents("php://input"),$elemento);
        if($index){
            return $elemento[$index];
        }
