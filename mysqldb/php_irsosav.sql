...
-- Volcando estructura de base de datos para php_irsosav
DROP DATABASE IF EXISTS `php_irsosav`;
CREATE DATABASE IF NOT EXISTS `php_irsosav` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci */;
USE `php_irsosav`;


-- Volcando estructura para tabla php_irsosav.documentos_tipos
...
-- Volcando datos para la tabla php_irsosav.documentos_tipos: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `documentos_tipos` DISABLE KEYS */;
REPLACE INTO `documentos_tipos` (`ID_DOCUMENTO_TIPO`, `DESCRIPCION`) VALUES
	(1, 'DNI'),
	(2, 'LE'),
	(3, 'LC'),
	(4, 'PASAPORTE');
...
-- Volcando estructura para tabla php_irsosav.estado_pedido
...
-- Volcando datos para la tabla php_irsosav.estado_pedido: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `estado_pedido` DISABLE KEYS */;
REPLACE INTO `estado_pedido` (`ID_ESTADO_PEDIDO`, `DESCRIPCION`) VALUES
	(1, 'ENTREGADO'),
	(2, 'CANCELADO');
/*!40000 ALTER TABLE `estado_pedido` ENABLE KEYS */;


-- Volcando estructura para tabla php_irsosav.localidades
...
) ENGINE=InnoDB AUTO_INCREMENT=2383 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- Volcando datos para la tabla php_irsosav.localidades: ~2.382 rows (aproximadamente)
/*!40000 ALTER TABLE `localidades` DISABLE KEYS */;
REPLACE INTO `localidades` (`ID_LOCALIDAD`, `ID_PROVINCIA`, `DESCRIPCION`) VALUES
	(1, 1, '25 de Mayo'),
	(2, 1, '3 de febrero'),
	(3, 1, 'A. Alsina'),
...
-- Volcando estructura para tabla php_irsosav.menues
...
-- Volcando datos para la tabla php_irsosav.menues: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `menues` DISABLE KEYS */;
/*!40000 ALTER TABLE `menues` ENABLE KEYS */;


-- Volcando estructura para tabla php_irsosav.menues_categoria
DROP TABLE IF EXISTS `menues_categoria`;
CREATE TABLE IF NOT EXISTS `menues_categoria` (
  `ID_MENU_CATEGORIA` int(11) NOT NULL,
  `DESCRIPCION` varchar(100) NOT NULL,
  PRIMARY KEY (`ID_MENU_CATEGORIA`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla php_irsosav.menues_categoria: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `menues_categoria` DISABLE KEYS */;
/*!40000 ALTER TABLE `menues_categoria` ENABLE KEYS */;


-- Volcando estructura para tabla php_irsosav.menues_estado
DROP TABLE IF EXISTS `menues_estado`;
CREATE TABLE IF NOT EXISTS `menues_estado` (
  `ID_MENU_ESTADO` int(11) NOT NULL,
  `DESCRIPCION` varchar(100) NOT NULL,
  PRIMARY KEY (`ID_MENU_ESTADO`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla php_irsosav.menues_estado: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `menues_estado` DISABLE KEYS */;
REPLACE INTO `menues_estado` (`ID_MENU_ESTADO`, `DESCRIPCION`) VALUES
	(1, 'HABILITADO'),
	(2, 'DESHABILITADO');
/*!40000 ALTER TABLE `menues_estado` ENABLE KEYS */;


-- Volcando estructura para tabla php_irsosav.menues_platos
DROP TABLE IF EXISTS `menues_platos`;
CREATE TABLE IF NOT EXISTS `menues_platos` (
...
-- Volcando datos para la tabla php_irsosav.menues_platos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `menues_platos` DISABLE KEYS */;
/*!40000 ALTER TABLE `menues_platos` ENABLE KEYS */;


-- Volcando estructura para tabla php_irsosav.pedidos_cabecera
...
-- Volcando datos para la tabla php_irsosav.pedidos_cabecera: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `pedidos_cabecera` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedidos_cabecera` ENABLE KEYS */;


-- Volcando estructura para tabla php_irsosav.pedidos_detalle
...
-- Volcando datos para la tabla php_irsosav.pedidos_detalle: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `pedidos_detalle` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedidos_detalle` ENABLE KEYS */;


-- Volcando estructura para tabla php_irsosav.pedidos_detalle_estado
DROP TABLE IF EXISTS `pedidos_detalle_estado`;
CREATE TABLE IF NOT EXISTS `pedidos_detalle_estado` (
  `ID_PEDIDO_DETALLE_ESTADO` int(11) NOT NULL,
  `DESCRIPCION` varchar(100) NOT NULL,
  PRIMARY KEY (`ID_PEDIDO_DETALLE_ESTADO`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla php_irsosav.pedidos_detalle_estado: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `pedidos_detalle_estado` DISABLE KEYS */;
REPLACE INTO `pedidos_detalle_estado` (`ID_PEDIDO_DETALLE_ESTADO`, `DESCRIPCION`) VALUES
	(1, 'ENTREGADO'),
	(2, 'EN PREPARACION'),
	(3, 'CANCELADO'),
	(4, 'ENVIADO A COCINA');
/*!40000 ALTER TABLE `pedidos_detalle_estado` ENABLE KEYS */;


-- Volcando estructura para tabla php_irsosav.pedidos_tipo
...
-- Volcando datos para la tabla php_irsosav.pedidos_tipo: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `pedidos_tipo` DISABLE KEYS */;
REPLACE INTO `pedidos_tipo` (`ID_TIPO_PEDIDOS`, `DESCRIPCION`) VALUES
	(1, 'DELIVERY');
/*!40000 ALTER TABLE `pedidos_tipo` ENABLE KEYS */;


-- Volcando estructura para tabla php_irsosav.platos
...
-- Volcando datos para la tabla php_irsosav.platos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `platos` DISABLE KEYS */;
/*!40000 ALTER TABLE `platos` ENABLE KEYS */;


-- Volcando estructura para tabla php_irsosav.provincias
...
-- Volcando datos para la tabla php_irsosav.provincias: ~24 rows (aproximadamente)
/*!40000 ALTER TABLE `provincias` DISABLE KEYS */;
REPLACE INTO `provincias` (`ID_PROVINCIA`, `DESCRIPCION`) VALUES
	(1, 'Buenos Aires'),
	(2, 'Buenos Aires-GBA'),
	(3, 'Capital Federal'),
	(4, 'Catamarca'),
...
-- Volcando estructura para tabla php_irsosav.usuarios
...
-- Volcando datos para la tabla php_irsosav.usuarios: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `usuarios` DISABLE KEYS */;
REPLACE INTO `usuarios` (`ID_USUARIO`, `USUARIO`, `DESCRIPCION`, `CLAVE`, `TELEFONO`, `ID_DOCUMENTO_TIPO`, `NRO_DOCUMENTO`, `ID_LOCALIDAD`, `ID_PROVINCIA`, `ID_USUARIO_CARGO`, `ID_USUARIO_ESTADO`) VALUES
	(1, '8633', 'Camila Soledad', 'Marte01', '58899999', 1, 36739367, 314, 1, 2, 1),
	(2, '8898', 'Savino Cecilia', 'Password01', '43466987', 1, 28858547, 314, 1, 2, 1),
	(3, '8635', 'tony corleone', 'tony', '5555-5555', 1, 32400777, 314, 3, 1, 1),
	(4, '8883', 'Formento Melina Abigail', 'Marte100', '51688896', 1, 38822913, 314, 1, 2, 1);
/*!40000 ALTER TABLE `usuarios` ENABLE KEYS */;


-- Volcando estructura para tabla php_irsosav.usuarios_cargo
DROP TABLE IF EXISTS `usuarios_cargo`;
CREATE TABLE IF NOT EXISTS `usuarios_cargo` (
  `ID_USUARIO_CARGO` int(11) NOT NULL,
  `DESCRIPCION` varchar(100) NOT NULL,
  PRIMARY KEY (`ID_USUARIO_CARGO`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla php_irsosav.usuarios_cargo: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `usuarios_cargo` DISABLE KEYS */;
REPLACE INTO `usuarios_cargo` (`ID_USUARIO_CARGO`, `DESCRIPCION`) VALUES
	(1, 'ADMIN'),
	(2, 'USUARIO'),
	(3, 'INVITADO');
...
-- Volcando estructura para tabla php_irsosav.usuarios_estado
...
-- Volcando datos para la tabla php_irsosav.usuarios_estado: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `usuarios_estado` DISABLE KEYS */;
REPLACE INTO `usuarios_estado` (`ID_USUARIO_ESTADO`, `DESCRIPCION`) VALUES
	(1, 'HABILITADO'),
	(2, 'DESHABILITADO');
/*!40000 ALTER TABLE `usuarios_estado` ENABLE KEYS */;
